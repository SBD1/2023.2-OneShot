...
**<a>Função de Agendamento de Eventos</a>**
```sql
...
**<a>Função de chamada de Dialogo</a>**
```sql
...
**<a>Função de Movimentação dentro de estruturas</a>**
```sql
...
**<a>Função de Gerenciamento de textos</a>**
```sql
...
**<a>Função de Finalização do jogo</a>**
```sql
